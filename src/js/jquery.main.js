	...
	OpenClose.prototype = {
		...
		attachEvents: function() {
			...
			if (this.options.event === 'hover') {
				...
				this.opener.on('mouseenter', this.mouseenterFn);
				this.holder.on('mouseleave', this.mouseleaveFn);
			}
		...
		destroy: function() {
			...
			if (this.options.event === 'hover') {
				this.opener.off('mouseenter', this.mouseenterFn);
				this.holder.off('mouseleave', this.mouseleaveFn);
			}
